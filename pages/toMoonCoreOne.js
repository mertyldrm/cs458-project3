        ...
        setResult(
          <div>
            ...
            <div style={styles.resultDisplayer}>
              <h2>
                The distance to the Moon's core with given latitude and
                longitude:{" "}
              </h2>
        ...
        if (err.response.status == 400)
          ...
          setResult(
            <div>
              ...
              <div style={styles.resultDisplayer}>
                <h1 style={{ color: "red" }}>
                  No country is found with given latitude and longitude!
                </h1>
              </div>
            </div>
          );
  ...
  return (
    <>
      <div style={styles.container}>
        ...
        <button onClick={handleSubmit} style={styles.submissionButtonThree}>
          Show Distance to Moon's Core
        </button>
      </div>
      {result}
    </>
