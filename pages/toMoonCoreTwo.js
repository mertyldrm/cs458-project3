          ...
          setResult(
            <div>
              ...
              <div style={styles.resultDisplayer}>
                <p style={{ color: "red" }}>
                  An error occurred. You should allow browser to detect your
                  location!
                </p>
              </div>
            </div>
    ...
    <>
      <div style={styles.container}>
        ...
        <div style={styles.inputContainer}>
          <p style={{ width: "400px", lineHeight: "2" }}>
            By clicking the button, you can calculate the distance from your
            current position to the Moon's core: (You should allow this website
            to use your location. Otherwise, there will be no result shown)
          </p>
        </div>
        <button onClick={getLocation} style={styles.submissionButtonFour}>
          Show Distance to the Moon's Core
        </button>
      </div>
      {result}
    </>
