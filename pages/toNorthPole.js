      ...
      <div style={styles.container}>
        ...
        <div style={styles.inputContainer}>
          <p style={{ width: "400px", lineHeight: "2" }}>
            ...
            current position to the north pole: (You should allow this website
            to use your location. Otherwise, there will be no result shown)
          </p>
        </div>
        <button onClick={getLocation} style={styles.submissionButtonTwo}>
          Show Distance to North Pole
        </button>
      </div>
      {result}
    </>
